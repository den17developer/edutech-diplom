						...
						<b-card no-body class="bg-transparent card-body pb-0 px-0 mt-2 mt-sm-0">
							<b-row class="d-sm-flex justify-sm-content-between mt-2 mt-md-0">
								...
								<div class="col d-sm-flex justify-content-between align-items-center">
									<div>
										<h1 class="my-1 fs-4">Чиваува</h1>
										<ul class="list-inline mb-0">
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">255</span>
												<span class="text-body fw-light"> очков</span>
											</li>{{ ' ' }}
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">7</span>
												<span class="text-body fw-light"> Пройденных курсов</span>
											</li>{{ ' ' }}
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">52</span>
												<span class="text-body fw-light"> Пройденных лекций</span>
											</li>
										</ul>
									</div>
									<div class="mt-2 mt-sm-0">
										<router-link :to="{ name: 'student.course' }" class="btn btn-outline-primary mb-0">Посмотреть курсы</router-link>
									</div>
								</div>
							</b-row>
						</b-card>
