  ...
  <section class="bg-light py-5 position-relative overflow-hidden">
    ...
    <b-container class="position-relative">
      <b-row class="g-4 align-items-center">
        <b-col md="6">
          <h1>Подать заявку в качестве преподователя</h1>
          <p>Делись знаниями, вдохновляй учеников и развивайся вместе с ними. Стать преподавателем — значит менять мир к лучшему каждый день.</p>
          <a href="#fill-instructor-form" class="btn btn-primary mb-0">Начать обучать сегодня</a>
        </b-col>
