				...
				<b-row class="justify-content-center position-relative">
					...
					<b-col cols="11" class="position-relative">
						<b-row class="align-items-center">
							<b-col lg="7">
								<h3 class="text-white">Стань инструктором!</h3>
								<p class="text-white mb-3 mb-lg-0">Делись знаниями, вдохновляй учеников и развивайся вместе с ними. Стать преподавателем — значит менять мир к лучшему каждый день.</p>
							</b-col>
							<b-col lg="5" class="text-lg-end">
								<a href="#fill-instructor-form" class="btn btn-lg btn-white mb-0">Начни обучать сегодня</a>
							</b-col>
						</b-row>
					</b-col>
				</b-row>
