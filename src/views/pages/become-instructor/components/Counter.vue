			...
			<div class="bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden">
				...
				<b-row class="g-4 position-relative align-items-center justify-content-center">
                  ...
                  class="purecounter display-6 text-orange fw-bold mb-0 h4" />
							<span class="display-6 text-orange mb-0">К</span>
						</div>
						<h6 class="mb-0 fw-bold">Общее количество студентов</h6>
					</b-col>
                  ...
                  class="purecounter display-6 text-orange fw-bold mb-0 h4" />
						...
						<h6 class="mb-0 fw-bold">Общее количество инструкторов</h6>
					</b-col>
                  ...
                  class="purecounter display-6 text-orange fw-bold mb-0 h4" />
						...
						<h6 class="mb-0 fw-bold">Общее количество курсов</h6>
					</b-col>
                  ...
                  class="purecounter display-6 text-orange fw-bold mb-0 h4" />
						...
						<h6 class="mb-0 fw-bold">Языки</h6>
					</b-col>
				</b-row>
			</div>
		</b-container>
