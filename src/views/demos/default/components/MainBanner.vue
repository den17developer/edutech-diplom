  ...
  <section class="position-relative overflow-hidden pt-5 pt-lg-3">
    ...
    <b-container>
      <b-row class="align-items-center g-5">
        <b-col lg="5" xl="6" class="position-relative z-index-1 text-center text-lg-start mb-7 mb-sm-0">
          ...
          <h1 class="mb-0 display-6">Безграничное обучение у вас
            <span class="position-relative">под рукой
          ...
          <p class="my-4 lead">Рынок онлайн-обучения с более чем 5 тысячами курсов и 10 миллионами студентов. Обучение проводят
            эксперты, которые помогут вам приобрести новые навыки.</p>

          <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
            <li class="list-inline-item me-2">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Учитесь вместе с экспертами
            </li>{{ ' ' }}
            <li class="list-inline-item me-2">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Получение сертификата
            </li>{{ ' ' }}
            <li class="list-inline-item">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Получение знаний
            </li>
          </ul>

          <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
            <a href="#" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">Начать</a>
            <div class="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
              <CustomGLightbox link="https://youtu.be/Bhr4yIbtizc?si=38sYwnMGdk5hIGfu"
                class="btn btn-round btn-primary-shadow mb-0 overflow-visible me-7">
                <font-awesome-icon :icon="faPlay" />
                <h6 class="mb-0 ms-3 fw-normal position-absolute start-100 top-50 translate-middle-y">Смотреть видео</h6>
              </CustomGLightbox>
            </div>
          </div>
        </b-col>

        <b-col lg="7" xl="6" class="text-center position-relative">
          ...
          <div
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="icon-lg bg-warning rounded-circle">
                <font-awesome-icon :icon="faEnvelope" class="text-white" />
              </span>
              <div class="text-start ms-3">
                <h6 class="mb-0 text-white">Поздравляем <span class="ms-4">
                    <font-awesome-icon :icon="faCheckCircle" class="text-success" />
                  </span></h6>
                <p class="mb-0 small text-white">Ваше поступление завершено</p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            :style="`background:url(${pattern01}) no-repeat center center; background-size:cover;`">
            <p class="text-white">Наши ежедневные новые студенты</p>
            <ul class="avatar-group mb-0">
              <li class="avatar avatar-sm">
                <img class="avatar-img rounded-circle border-white" :src="avatar01" alt="avatar">
              </li>
              <li class="avatar avatar-sm">
                <img class="avatar-img rounded-circle border-white" :src="avatar02" alt="avatar">
              </li>
              <li class="avatar avatar-sm">
                <img class="avatar-img rounded-circle border-white" :src="avatar03" alt="avatar">
              </li>
              <li class="avatar avatar-sm">
                <img class="avatar-img rounded-circle border-white" :src="avatar04" alt="avatar">
              </li>
              <li class="avatar avatar-sm">
...
import { faPlay, faEnvelope, faCheckCircle } from '@fortawesome/free-solid-svg-icons';
...
import element07 from '@/assets/images/element/07.png';
...
import pattern01 from '@/assets/images/pattern/01.png';
</script>