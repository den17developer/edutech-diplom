    ...
    <b-container>
      <b-row class="mb-4">
        <b-col lg="8" class="mx-auto text-center">
          <h2 class="fs-1">Самые популярные курсы</h2>
          <p class="mb-0">Выбирайте из сотен курсов, предлагаемых специализированными организациями</p>
        </b-col>
      </b-row>
      ...
      <b-tabs pills nav-class="nav-pills-bg-soft justify-content-sm-center mb-4 px-3" content-class="mt-4"
        ...
        <b-tab title="Веб дизайн" class="fade" title-item-class="me-2 me-sm-5">
          <b-row class="g-4">
        ...
        <b-tab title="Разработка" class="fade" title-item-class="me-2 me-sm-5">
          <b-row class="g-4">
            <template v-for="(item, idx) in courseList" :key="idx">
        ...
        <b-tab title="Графический дизайн" class="fade" title-item-class="me-2 me-sm-5">
          <b-row class="g-4">
            <template v-for="(item, idx) in courseList" :key="idx">
        ...
        <b-tab title="Маркетинг" class="fade" title-item-class="me-2 me-sm-5">
          <b-row class="g-4">
            <template v-for="(item, idx) in courseList" :key="idx">
        ...
        <b-tab title="Финансы" class="fade" title-item-class="me-2 me-sm-5">
          <b-row class="g-4">
            <template v-for="(item, idx) in courseList" :key="idx">
