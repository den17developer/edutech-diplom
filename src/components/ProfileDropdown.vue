  ...
  <DropDown :custom-class="className">
    ...
    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
      ...
      <li><a class="dropdown-item" href="#">
          <BIconPerson class="fa-fw me-2" />Изменить профиль
        </a></li>
      <li><a class="dropdown-item" href="#">
          <BIconGear class="fa-fw me-2" />Настройки
        </a></li>
      <li><a class="dropdown-item" href="#">
          <BIconInfoCircle class="fa-fw me-2" />Помощь
        </a></li>
      <li><a class="dropdown-item bg-danger-soft-hover" href="#">
          <BIconPower class="fa-fw me-2" />Выйти
        </a></li>
      <li>
        <hr class="dropdown-divider">
      </li>
